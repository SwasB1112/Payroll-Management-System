...
def connect():
    global myconn
    global cur
    myconn = mysql.connector.connect(host='localhost', user='root', passwd='swastayan', database="payroll_forms")
    cur = myconn.cursor(buffered=True)

def new_connect():
    tempMyconn = mysql.connector.connect(host='localhost', user='root', passwd='swastayan')
